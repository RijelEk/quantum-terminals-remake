...
if (process.env.NODE_ENV !== 'production') {
  ...
  existsSync(path.join(__dirname, "../uploads")) || mkdirSync(path.join(__dirname, "../uploads")); //set up save folder for files
  ...
  await createConnection({
      type: "postgres",
      url:"postgresql://postgres:postgres@localhost:5432/memo",
      logging: true,
